...
public class DrinkController {
    ...
    private final pl.coderslab.DrinkApp.service.DrinksManagementsService drinksManagementsService;

    public DrinkController(DrinkDao drinkDao, pl.coderslab.DrinkApp.service.DrinksManagementsService drinksManagementsService) {
