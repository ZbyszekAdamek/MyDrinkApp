                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <img src="/theme/img/fire.jpg" width="260" height="200" alt="alkohol">
                        </div>
                        <div class="col-auto">
            ...
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Dowiedz się więcej
                            </div>
                            <img src="/theme/img/RUM.jpg" width="260" height="200" alt="RUM">
                        </div>
                        <div class="col-auto">
